...
document.addEventListener("DOMContentLoaded", function() {
    var cargaAudio = document.getElementById("carga-audio");
    cargaAudio.play().catch(function(error) {
      // El navegador bloquea la reproducción automática del sonido.
      // Aquí puedes agregar un mensaje o una acción alternativa.
    });
});
...
$(window).on('load',function (){
    ...
    if ($('.home-page').length > 0) {
        if ($(window).width() > 768 && window.orientation !== 0) {
            ...
            let linkData = {
                ...
                '6': scrollDurationHome * 5 + projectBlocksScroll + addBlocksScroll*2,
                '7': scrollDurationHome * 6 + projectBlocksScroll + newsBlocksScroll + addBlocksScroll*4,
            }
        ...
        menuNews.forEach((title, index) => {
            tl3.from(title, {autoAlpha: 0, right: -700 - 130 * index, ease: Power1.easeOut}, 0);
        });
        ...
        let st4 = ScrollTrigger.create({
            trigger: "body",
            scrub:parseInt(scrubPower)/100,
            start: "0 -" + (scrollDurationHome * (sectionNumber +0.5) + projectBlocksScroll + addBlocksScroll*2),
            end: "+=" + (scrollDurationHome),
            onUpdate: ({progress, direction, isActive}) => {
                //medida();
                if (progress >= 0.9) {
        ...
        awardsExp.forEach((award, index) => {
            tl41.from(award, {autoAlpha: 0, bottom: -800 - 300 * index, ease: Power1.easeOut}, 0);
        });
        //Inscripciones end
        ...
        tlTeachersBtn.from(".teachers .content__description", 0.3, {
        autoAlpha: 0,
        left: -600,
        ease: Power1.easeOut
        });
        tlTeachersBtn.from(".teachers .content__btn-block > *", 0.3, {scale: 0, ease: Back.easeOut});
        ...
        let titlesTeachers = gsap.utils.toArray(".teachers .content__title > *");
        ...
        tl51.from('.teachers .content__subtitle', {autoAlpha: 0, top: -200, ease: Power1.easeOut}, 0);
        let awardsTeachers = gsap.utils.toArray(".teachers__list .content__award");
        ...
        tlAvardsBtn.from(".awards .content__btn-block > *", 0.4, {scale: 0, ease: Back.easeOut});
        ...
        let st6 = ScrollTrigger.create({
            trigger: "body",
            scrub:parseInt(scrubPower)/100,
            start: "0 -" + (scrollDurationHome * (sectionNumber - 0.9) + projectBlocksScroll + newsBlocksScroll + addBlocksScroll*2.5),
            end: "+=" + (scrollDurationHome),
            onUpdate: ({progress, direction, isActive}) => {
               // medida();
                if (progress >= 0.9) {
        ...
        tl61.from('.awards .content__subtitle', {autoAlpha: 0, top: -200, ease: Power1.easeOut}, 0);
       ...
       //Testimonios start
        ...
        let st7 = ScrollTrigger.create({
            trigger: "body",
            scrub:parseInt(scrubPower)/100,
            start: "0 -" + (scrollDurationHome * (sectionNumber+1.2) + projectBlocksScroll + addBlocksScroll*2),
            end: "+=" + (scrollDurationHome/2),
            onToggle: ({progress, direction, isActive}) => {
                medida();
                if (!isActive && direction > 0) {
        ...
        clientsTesti.forEach((client, index) => {
            tl7.from(client, {autoAlpha: 0, bottom: -600 - 200 * index, ease: Power1.easeOut}, 0);
        });
        ...
        tl71.from('.testimonials .content__subtitle', {autoAlpha: 0, top: -200, ease: Power1.easeOut}, 0);
        //Testimonios end
        ...
        let st8 = ScrollTrigger.create({
            trigger: "body",
            scrub:parseInt(scrubPower)/100,
            start: "0 -" + (scrollDurationHome * (sectionNumber - 1.2) + projectBlocksScroll + newsBlocksScroll + addBlocksScroll*5),
            end: "+=" + (scrollDurationHome),
            onToggle: ({progress, direction, isActive}) => {
                medida();
                if (!isActive && direction > 0) {
        ...
        //contacts end
            ...
            let stScroll = ScrollTrigger.create({
                ...
                end: "+=" + (scrollDurationHome * (sections.length - 7)),
                snap: 0.3335*parseInt(snapMode),
                onUpdate: function () {
                    blockNavigation = true;
                    $('.header__menu').addClass('blocked');
                },
            ...
            tlScroll.fromTo(sections, {xPercent: -100}, {xPercent: -100 * (sections.length - 6),ease: "none"}, 0);
            ...
            let stScrollLast = ScrollTrigger.create({
                trigger: "body",
                scrub:parseInt(scrubPower)/100,
                start: "0 -" + (scrollDurationHome * (sections.length -6) + projectBlocksScroll + newsBlocksScroll + addBlocksScroll*2.65),
                end: "+=" + (scrollDurationHome),
                snap: parseInt(snapMode),
                onUpdate: function () {
                    blockNavigation = true;
            ...
            tlScrollLast.fromTo(sections, {xPercent: -100*(sections.length - 6.001)}, {xPercent: -100 * (sections.length -5),ease: "none"}, 0);

            
            tlScrollLast = gsap.timeline();
            stScrollLast = ScrollTrigger.create({
                trigger: "body",
                scrub:parseInt(scrubPower)/100,
                start: "0 -" + (scrollDurationHome * (sections.length -5) + projectBlocksScroll + newsBlocksScroll + addBlocksScroll*2.65),
                end: "+=" + (scrollDurationHome),
                snap: parseInt(snapMode),
                onUpdate: function () {
                    blockNavigation = true;
            ...
            tlScrollLast.fromTo(sections, {xPercent: -100*(sections.length - 5)}, {xPercent: -100 * (sections.length -4),ease: "none"}, 0);
            ...
            stScrollLast = ScrollTrigger.create({
                trigger: "body",
                scrub:parseInt(scrubPower)/100,
                start: "0 -" + (scrollDurationHome * (sections.length -4) + projectBlocksScroll + newsBlocksScroll + addBlocksScroll*2.65),
                end: "+=" + (scrollDurationHome),
                snap: parseInt(snapMode),
                onUpdate: function () {
                    blockNavigation = true;
            ...
            tlScrollLast.fromTo(sections, {xPercent: -100*(sections.length - 4)}, {xPercent: -100 * (sections.length -2.999),ease: "none"}, 0);
            ...
            stScrollLast = ScrollTrigger.create({
                trigger: "body",
                scrub:parseInt(scrubPower)/100,
                start: "0 -" + (scrollDurationHome * (sections.length -3) + projectBlocksScroll + newsBlocksScroll + addBlocksScroll*4),
                end: "+=" + (scrollDurationHome),
                snap: parseInt(snapMode),
                onUpdate: function () {
                    blockNavigation = true;
            ...
            tlScrollLast.fromTo(sections, {xPercent: -100*(sections.length - 3)}, {xPercent: -100 * (sections.length -2),ease: "none"}, 0);
            ...
            tlScrollLast.fromTo(sections, {xPercent: -100*(sections.length - 2.001)}, {xPercent: -100 * (sections.length -1),ease: "none"}, 0);
            ...
            $(document).on('click', '.news__menu a', function () {
                ...
                let parent = $(this).parent(),
                    ...
                    scrollTo = parseInt(linkData[2]) + addBlocksScroll + newsBlocksScroll*progress;
                st.scroll(scrollTo);
            });
        } else {
   ...
   function getHeiht(){
    ...
    var bodyHeight = Math.max(bodyScrollHeight, bodyOffsetHeight);
    return bodyHeight;
   };
    function Aelem(){
        let x=getHeiht();
...
function Profesores(){
  ...
  function Testimonios(){
   ...
   function medida(){
   let x=(window.scrollY)/(document.body.scrollHeight-window.innerHeight)*100;
   if(isNaN(x)){
       x=0;
   }
   x=x.toFixed(0);
...
//funciones extra
function imagesDetails(indicador){
    if(indicador==1){
    const container= document.querySelector("#NivelesImg");
    container.style.height='300px';        
    }else{
        if(indicador==2){
    const container= document.querySelector("#MateriasImg");
    container.style.height='300px';        
    }; 
    };
  ...
  function telefono (){
      const container= document.querySelector("#PhoneImg");
      container.style.rotation("360deg");
  }
  let x=true;
  function mqm(){
      ...
      container.click();
      if (x==true){
        let sound=document.getElementById("audioDeCarga");
        sound.play();
        x=false;
      }
  };
  ...
  let bandera= document.querySelector("#profesCaratula");

  punto.forEach((cadaPunto, i)=>{
      punto[i].addEventListener('click',()=>{
              
        //let posicion=i+1;
        //let operación=posicion*-50;
        //grande.style.transform= `translateX(${operación}%)`;
        switch(i){
            case 0:
                    document.getElementById('frames').classList.add('animated');
                    document.getElementById('profesNombre').innerHTML='Romina<br>Coria<br>';
                    document.getElementById('descript').innerHTML='Módulos 1 y 5 <br>Cada uno de nuestros profesores tiene una amplia experiencia y ha demostrado un profundo conocimiento en su área de especialización y algunos de ellos son reconocidos internacionalmente. Todos ellos comparten un compromiso con la excelencia académica y están ansiosos por compartir sus conocimientos y experiencia con nuestros estudiantes para que estos puedan gestionar sus emociones y ayudar a otros. Hace click en su foto y descubre que materia tendrás con cada uno de ellos.';
            ...
            case 1:
                    ...
                    document.getElementById('descript').innerHTML='Módulos 2 y 10 <br>Cada uno de nuestros profesores tiene una amplia experiencia y ha demostrado un profundo conocimiento en su área de especialización y algunos de ellos son reconocidos internacionalmente. Todos ellos comparten un compromiso con la excelencia académica y están ansiosos por compartir sus conocimientos y experiencia con nuestros estudiantes para que estos puedan gestionar sus emociones y ayudar a otros. Hace click en su foto y descubre que materia tendrás con cada uno de ellos.';
            ...
            case 2:
                document.getElementById('frames').classList.add('animated'); 
                   ...
                   document.getElementById('descript').innerHTML='Módulo 3 <br>Cada uno de nuestros profesores tiene una amplia experiencia y ha demostrado un profundo conocimiento en su área de especialización y algunos de ellos son reconocidos internacionalmente. Todos ellos comparten un compromiso con la excelencia académica y están ansiosos por compartir sus conocimientos y experiencia con nuestros estudiantes para que estos puedan gestionar sus emociones y ayudar a otros. Hace click en su foto y descubre que materia tendrás con cada uno de ellos.';
                    document.getElementById('frames').innerHTML='<iframe src=""></iframe>';
                    setTimeout(function() {  document.getElementById('frames').classList.remove('animated'); }, 2000);
                    break;
            case 3: 
                    ...
                    document.getElementById('descript').innerHTML='Módulo 4 <br>Cada uno de nuestros profesores tiene una amplia experiencia y ha demostrado un profundo conocimiento en su área de especialización y algunos de ellos son reconocidos internacionalmente. Todos ellos comparten un compromiso con la excelencia académica y están ansiosos por compartir sus conocimientos y experiencia con nuestros estudiantes para que estos puedan gestionar sus emociones y ayudar a otros. Hace click en su foto y descubre que materia tendrás con cada uno de ellos.';
                    document.getElementById('frames').innerHTML='<iframe src=""></iframe>';
                    setTimeout(function() {  document.getElementById('frames').classList.remove('animated'); }, 2000);
                    break;
            case 4: 
                    document.getElementById('frames').classList.add('animated');
                    document.getElementById('profesNombre').innerHTML='Evangelina<br>Ficetti<br>';
                    document.getElementById('descript').innerHTML='Módulo 6 <br>Cada uno de nuestros profesores tiene una amplia experiencia y ha demostrado un profundo conocimiento en su área de especialización y algunos de ellos son reconocidos internacionalmente. Todos ellos comparten un compromiso con la excelencia académica y están ansiosos por compartir sus conocimientos y experiencia con nuestros estudiantes para que estos puedan gestionar sus emociones y ayudar a otros. Hace click en su foto y descubre que materia tendrás con cada uno de ellos.';
                    document.getElementById('frames').innerHTML='<iframe src="https://player.vimeo.com/video/834039982?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture"  title="PROFESOR VANGE"></iframe>';
                    setTimeout(function() {  document.getElementById('frames').classList.remove('animated'); }, 2000);
                    break;
            case 5: 
                    document.getElementById('frames').classList.add('animated');
                    document.getElementById('profesNombre').innerHTML='Lucila<br>Bettin<br>';
                    document.getElementById('descript').innerHTML='Módulo 7 <br>Cada uno de nuestros profesores tiene una amplia experiencia y ha demostrado un profundo conocimiento en su área de especialización y algunos de ellos son reconocidos internacionalmente. Todos ellos comparten un compromiso con la excelencia académica y están ansiosos por compartir sus conocimientos y experiencia con nuestros estudiantes para que estos puedan gestionar sus emociones y ayudar a otros. Hace click en su foto y descubre que materia tendrás con cada uno de ellos.';
            ...
            case 6: 
                    document.getElementById('frames').classList.add('animated');
                    document.getElementById('profesNombre').innerHTML='Juan<br>Coria<br>';
                    document.getElementById('descript').innerHTML='Módulo 8 <br>Cada uno de nuestros profesores tiene una amplia experiencia y ha demostrado un profundo conocimiento en su área de especialización y algunos de ellos son reconocidos internacionalmente. Todos ellos comparten un compromiso con la excelencia académica y están ansiosos por compartir sus conocimientos y experiencia con nuestros estudiantes para que estos puedan gestionar sus emociones y ayudar a otros. Hace click en su foto y descubre que materia tendrás con cada uno de ellos.';
                    document.getElementById('frames').innerHTML='<iframe src="https://player.vimeo.com/video/839780278?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"></iframe>';
                    setTimeout(function() {  document.getElementById('frames').classList.remove('animated'); }, 2000);
                    break;
            case 7: document.getElementById('profesNombre').innerHTML='Rubén<br>Marreta<br>';
                    document.getElementById('descript').innerHTML='Módulo 9 <br>Cada uno de nuestros profesores tiene una amplia experiencia y ha demostrado un profundo conocimiento en su área de especialización y algunos de ellos son reconocidos internacionalmente. Todos ellos comparten un compromiso con la excelencia académica y están ansiosos por compartir sus conocimientos y experiencia con nuestros estudiantes para que estos puedan gestionar sus emociones y ayudar a otros. Hace click en su foto y descubre que materia tendrás con cada uno de ellos.';
                    document.getElementById('frames').innerHTML='<iframe src="https://player.vimeo.com/video/841897582?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"></iframe>';
                    setTimeout(function() {  document.getElementById('frames').classList.remove('animated'); }, 2000);
                    break;
        }
