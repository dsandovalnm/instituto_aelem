      ...
      punto[i].addEventListener('click',()=>{
        ...
        switch(i){
            ...
            case 4: 
                    ...
                    document.getElementById('descript').innerHTML='Módulo 6 <br>Evangelina Ficetti es Licenciada en Psicopedagogía y Magister en Educación. Ejerció la docencia en la Univesidad Católica de Córdoba. Se desempenó como Presidente del Colegio Profesional de Psicopedagogos de la Provincia de Córdoba.Trabajó enn Departamentos de Orientación Escolar de los tres niveles educativos de la ciudad de Córdoba, de gestión pública y privada. Formó árte del equipo técnico de un hogar de niños judicializados en dichas ciudad. Fundadora y Directora de ABBA (Instituto de Enseñanza para padres y profesionales de la salud mental). se desempeña en la area de contención emocional y pastoral de familias en la fundación Nueva Mente en Córdoba.';
            ...
            case 6: 
                    ...
                    document.getElementById('descript').innerHTML='Módulo 8 <br>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam dignissimos esse tenetur ab. Minima ratione tempora soluta doloribus alias consequuntur qui vel corrupti aliquid amet? Aperiam, laboriosam suscipit ratione nobis quis deserunt nisi hic rerum porro dolorum cumque distinctio eum dolores, modi ex pariatur quibusdam quasi enim nam dolore illo doloribus delectus possimus. Maiores sit ipsam quos doloremque accusantium est numquam obcaecati hic qui consequuntur, perspiciatis exercitationem rerum corporis itaque alias sunt provident dolores. Odio qui recusandae nihil voluptatum fugit?';
            ...
            case 7: document.getElementById('profesNombre').innerHTML='Rubén<br>Marreta<br>';
                    document.getElementById('descript').innerHTML='Módulo 9 <br>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam dignissimos esse tenetur ab. Minima ratione tempora soluta doloribus alias consequuntur qui vel corrupti aliquid amet? Aperiam, laboriosam suscipit ratione nobis quis deserunt nisi hic rerum porro dolorum cumque distinctio eum dolores, modi ex pariatur quibusdam quasi enim nam dolore illo doloribus delectus possimus. Maiores sit ipsam quos doloremque accusantium est numquam obcaecati hic qui consequuntur, perspiciatis exercitationem rerum corporis itaque alias sunt provident dolores. Odio qui recusandae nihil voluptatum fugit?';
